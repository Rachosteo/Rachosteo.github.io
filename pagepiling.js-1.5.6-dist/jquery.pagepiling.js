...
(function ($, document, window, undefined) {
    ...
    $.fn.pagepiling = function (custom) {
        ...
        var lastAnimation = 0;
        var lastHitEdgeOfScrollableSection = new Date().getTime();
        ...
        */
        function scrollPage(destination, animated) {
            ...
            lastHitEdgeOfScrollableSection = timeNow;
        }
        ...
        function scrolling(type, scrollable){
            ...
            if(scrollable.length > 0 ){
                ...
                if(isScrolled(check, scrollable)){
                    var timeNow = new Date().getTime();
                    // When first hitting the start/end of the scroll, remember the current time
                    if (lastHitEdgeOfScrollableSection == 0) {
                        lastHitEdgeOfScrollableSection = timeNow;
                        return true;
                    }
                    // Cancel scroll if within set time period since first hitting the start/end
                    if (timeNow - lastHitEdgeOfScrollableSection < scrollDelay + options.scrollingSpeed) {
                        return true;
                    }
                    scrollSection();
                }else{
                    lastHitEdgeOfScrollableSection = 0;
                    return true;
                }
            }else{
                //moved up/down
